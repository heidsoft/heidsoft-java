 ...
 * defines the {@link #resolve(heidsoft.jvm.com.sun.nio.file.Path) resolve} and {@link #resolveSibling(heidsoft.jvm.com.sun.nio.file.Path)
    ...
    extends Comparable<Path>, Iterable<Path>, Watchable
{
     ...
     * #startsWith(heidsoft.jvm.com.sun.nio.file.Path) startsWith(Path)} method. On UNIX for example, the path
     ...
     * the given path string, in exactly the manner specified by the {@link
     * #endsWith(heidsoft.jvm.com.sun.nio.file.Path) endsWith(Path)} method. On UNIX for example, the path
     ...
     * #resolve(heidsoft.jvm.com.sun.nio.file.Path) resolve} method. For example, suppose that the name
     ...
     * @return  the resulting path
     *
     * @see #resolve(heidsoft.jvm.com.sun.nio.file.Path)
     */
     ...
     * specified by the {@link #resolveSibling(heidsoft.jvm.com.sun.nio.file.Path) resolveSibling} method.
     *
     * @param   other
     ...
     *
     * <p> Relativization is the inverse of {@link #resolve(heidsoft.jvm.com.sun.nio.file.Path) resolution}.
     * This method attempts to construct a {@link #isAbsolute relative} path
     * that when {@link #resolve(heidsoft.jvm.com.sun.nio.file.Path) resolved} against this path, yields a
     ...
     * path.
     *
     * <p> If this path is already {@link heidsoft.jvm.com.sun.nio.file.Path#isAbsolute absolute} then this
