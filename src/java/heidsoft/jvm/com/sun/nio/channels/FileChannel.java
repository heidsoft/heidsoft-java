...
package heidsoft.jvm.com.sun.nio.channels;
    ...
    implements SeekableByteChannel, GatheringByteChannel, ScatteringByteChannel
{
     ...
     *   ({@link heidsoft.jvm.com.sun.nio.channels.FileChannel.MapMode#READ_ONLY MapMode.READ_ONLY}) </p></li>
     *
     *   <li><p> <i>Read/write:</i> Changes made to the resulting buffer will
     *   eventually be propagated to the file; they may or may not be made
     *   visible to other programs that have mapped the same file.  ({@link
     *   heidsoft.jvm.com.sun.nio.channels.FileChannel.MapMode#READ_WRITE MapMode.READ_WRITE}) </p></li>
     *
     *   <li><p> <i>Private:</i> Changes made to the resulting buffer will not
     *   be propagated to the file and will not be visible to other programs
     *   that have mapped the same file; instead, they will cause private
     *   copies of the modified portions of the buffer to be created.  ({@link
     *   heidsoft.jvm.com.sun.nio.channels.FileChannel.MapMode#PRIVATE MapMode.PRIVATE}) </p></li>
     *
     * </ul>
     *
     ...
     *
     * @param  mode
     *         One of the constants {@link heidsoft.jvm.com.sun.nio.channels.FileChannel.MapMode#READ_ONLY READ_ONLY}, {@link
     *         heidsoft.jvm.com.sun.nio.channels.FileChannel.MapMode#READ_WRITE READ_WRITE}, or {@link heidsoft.jvm.com.sun.nio.channels.FileChannel.MapMode#PRIVATE
     *         PRIVATE} defined in the {@link heidsoft.jvm.com.sun.nio.channels.FileChannel.MapMode} class, according to
     ...
     *
     * @throws NonReadableChannelException
     *         If the <tt>mode</tt> is {@link heidsoft.jvm.com.sun.nio.channels.FileChannel.MapMode#READ_ONLY READ_ONLY} but
     *         this channel was not opened for reading
     *
     * @throws NonWritableChannelException
     *         If the <tt>mode</tt> is {@link heidsoft.jvm.com.sun.nio.channels.FileChannel.MapMode#READ_WRITE READ_WRITE} or
     *         {@link heidsoft.jvm.com.sun.nio.channels.FileChannel.MapMode#PRIVATE PRIVATE} but this channel was not opened
